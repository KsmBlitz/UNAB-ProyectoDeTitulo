...
<template>
  <div class="flex justify-center items-center min-h-screen p-4 relative overflow-hidden bg-gray-100">
  ...
  <div
    class="py-12 px-12 rounded-2xl shadow-2xl border w-full max-w-[480px] text-center relative z-10 bg-white border-gray-200"
  >
      <div class="mb-10">
        <div class="flex justify-center mb-6">
          <img src="@/assets/Logo Embalse IoT.png" alt="AquaStat Logo" class="h-32 w-auto object-contain drop-shadow-md">
        </div>
